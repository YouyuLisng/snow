...
<script type="text/javascript" src="//ajax.aspnetcdn.com/ajax/jquery.validate/1.15.0/localization/messages_zh_tw.js"></script>
...
<style>
    ...
    *:focus { outline: none; }
    .error {color:red    }
        ...
        fbq('init', '1406326859400027'); // Insert your pixel ID here.
        fbq('track', 'PageView');
    </script>
...
<section id="contact" class="home-section bg-white" runat="server" style="background-color:rgb(255,255,255);">
    <div id="FormContainer" class="container" runat="server">
        <div class="row">
            <div class="col-md-offset-2 col-md-8">
                <div class="section-heading">
                    <h2  id="service">專人為我服務</h2>
                </div>
            </div>
        </div>
        <div class="row">
            <div class="col-md-offset-1 col-md-10" id="form">
                ...
                <div class="form-group">
                    <div class="col-md-offset-2 col-md-8 text-left" style="margin-bottom:10px;">
                        ★<label for="inputTel">電　　話 (提醒您，若您填寫市話請別忘記區域碼，如：02-23456789)</label>
                        <asp:TextBox ID="Txttel" runat="server" CssClass="form-control required" Placeholder="格式 XXXX-XXXXXX 或 XX-XXXXXXXX"></asp:TextBox>
                    </div>
                </div>
                <div class="form-group">
                    <div class="col-md-offset-2 col-md-8 text-left" style="margin-bottom:10px;">
                ...
                <div class="form-group"  id="btn_comfirm">
                ...
                <div>
                  <div class="col-md-offset-2 col-md-8">
                    <div class="TEL" id="TEL_sec">
                      <div class="telbtn" onclick="gaCallEventBtn();">免填資料，電話輕鬆講</div>
                      </div>
                  </div>
                  </div>
                </div>
