...
(function ($) {
  ...
  $window.on('elementor/frontend/init', function () {
    ...
    $.each(fnHanlders, function (widgetName, handlerFn) {
      elementorFrontend.hooks.addAction('frontend/element_ready/index.html' + widgetName, handlerFn);
    });
    var classHandlers = {
    ...
    $.each(classHandlers, function (widgetName, handlerClass) {
      elementorFrontend.hooks.addAction('frontend/element_ready/index.html' + widgetName, function ($scope) {
